...
$maps = getItems('.', false,  '/('.base64_encode($path).')\.map$/', null, null, true, true);
rsort($maps);
$tmp_arr = array();
foreach ($maps as $map) {
...
<body>
<div id="files-table">
<p>Nombre de fichier au total: <?php echo $files_total;?><br />

<a href="?<?php echo buildUrlQuery(array('scan' => true, 'hashcompare' => ''), true); ?>" title="click for scan again">Verifier les réception d'absences</a></p>
...
<form method="post" action="filelist.php">
    <fieldset>
        <table>
