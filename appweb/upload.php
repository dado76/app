<!--This code is written by Sandeep Satone for Quora forum  -->
<!DOCTYPE html>
<html lang="en">

<head>
    <meta charset="UTF-8">
    <title>How can I convert my HTML form into a PDF using scripting?</title>
</head>
...
<form action="">
    <fieldset>
        ...
        <fieldset><legend>Note</legend>
            ...
            fonction habituelle – et à renouveler chaque jour si besoin est, par e-mail <a href="mailto:Jessica.Jimenez@lehavremetrofr">Jessica.Jimenez@lehavremetrofr </a>
        ...
        <input type="submit" value="Save as PDF" onclick="window.print()"> </fieldset>
</form>
</body>
...
<form enctype="multipart/form-data" action="upload.php" method="POST">
    ...
    <button onclick="myFunction()" type="submit" value="Upload"></button>
</form>
</body>
</html>
<?PHP
if(!empty($_FILES['uploaded_file']))
{
    ...
    if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $path)) {
        echo "The file ".  basename( $_FILES['uploaded_file']['name']);
           echo "<p style=\"color: GREEN; \"><strong>Information:</strong>FORMULAIRE SAUVEGARDER </p>
";
    } else{
        echo "<p style=\"color: red; \"><strong>Information:</strong>PROBLEME VEUILLEZ RESSAYER OU CONTACTER LE SERVICE INFORMATIQUE </p>
";
    }
}
?>
